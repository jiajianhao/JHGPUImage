...
- (void)viewDidLoad {
     ...
     */
    GPUImageRGBFilter *filter1         = [[GPUImageRGBFilter alloc] init];//RGB
    GPUImageToonFilter *filter2        = [[GPUImageToonFilter alloc] init];//黑色描边
    GPUImageColorInvertFilter *filter3 = [[GPUImageColorInvertFilter alloc] init];//反色
    GPUImageSepiaFilter       *filter4 = [[GPUImageSepiaFilter alloc] init];//怀旧，褐色
